{
  programs.plasma = {
    ...
    configFile = {
      ...
      "kactivitymanagerdrc"."activities"."fe1f0f31-9586-4425-94ef-9bbebd7c5e20" =
        "Default";
      "kactivitymanagerdrc"."main"."currentActivity" =
        "fe1f0f31-9586-4425-94ef-9bbebd7c5e20";
      ...
      "kdeglobals"."General"."menuFont" =
        "Iosevka Extended,12,-1,5,50,0,0,0,0,0";
      ...
      "kdeglobals"."KScreen"."ScreenScaleFactors" =
        "HDMI-0=1.25;DP-0=1.25;DP-1=1.25;DP-2=1.25;DP-3=1.25;DP-4=1.25;DP-5=1.25;";
      ...
      "khotkeysrc"."Data_2_1Triggers0"."Uuid" =
        "{a5e0dd16-58c7-4bfb-bfdf-9a07f542d16d}";
      ...
      "khotkeysrc"."Data_2_2Triggers0"."Uuid" =
        "{f703d4af-4d18-41a4-80f7-fb984c502d4f}";
      ...
      "khotkeysrc"."Data_2_3Triggers0"."Uuid" =
        "{299d96f6-5a11-4af3-a4e6-a560d97820da}";
      ...
      "khotkeysrc"."Data_2_4Triggers0"."Uuid" =
        "{b9678218-cc2a-4ea3-a2d7-6e25ac1ece84}";
      ...
      "khotkeysrc"."Data_2_5Triggers0"."Uuid" =
        "{01df147f-b99a-4ae2-8133-3271de564a19}";
      ...
      "khotkeysrc"."Data_2_6Triggers0"."Uuid" =
        "{f8ec23e5-0ef9-4186-bfe1-3151cb281e19}";
      ...
      "khotkeysrc"."Data_2_8Triggers0"."Uuid" =
        "{7d47a404-6a53-495f-a3ff-db87ee1126e0}";
      ...
      "khotkeysrc"."Data_4Triggers0"."Uuid" =
        "{493fb711-0be8-466e-82b9-c16a3a573956}";
      ...
      "plasmarc"."Wallpapers"."usersWallpapers" =
        "/home/cfeeley/Downloads/10-14-Day-Thumb.jpg";
    };
  };
}
