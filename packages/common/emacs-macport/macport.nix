...
import ./generic.nix (rec {
  ...
  patches =
    if titlebarPatches then
      fetchpatch: [
        (fetchpatch {
          name = "emacs-mac-title-bar-9.0.patch";
          url =
            "https://raw.githubusercontent.com/railwaycat/homebrew-emacsmacport/89fc33ae62c82c7ff5894967c1038ef87bb0b418/patches/emacs-mac-title-bar-9.0.patch";
        ...
        (fetchpatch {
          ...
          url =
            "https://raw.githubusercontent.com/railwaycat/homebrew-emacsmacport/667f0efc08506facfc6963ac1fd1d5b9b777e094/patches/multi-tty-27.diff";
  ...
  macportPatches = builtins.fetchTarball {
    url =
      "ftp://ftp.math.s.chiba-u.ac.jp/emacs/emacs-${version}-mac-${macportVersion}.tar.gz";
