  ...
  sources = {
    ...
    "@types/node-12.12.53" = {
      ...
      src = fetchurl {
        ...
        sha512 = "51MYTDTyCziHb70wtGNFRwB4l+5JNvdqzFSkbDvpbftEgVUBEE+T5f7pROhWMp/fxp07oNIEQZd5bbfAH22ohQ==";
      };
    };
    "@types/vscode-1.55.0" = {
    ...
    "ts-loader-9.1.2" = {
      ...
      src = fetchurl {
        ...
        sha512 = "ryMgATvLLl+z8zQvdlm6Pep0slmwxFWIEnq/5VdiLVjqQXnFJgO+qNLGIIP+d2N2jsFZ9MibZCVDb2bSp7OmEA==";
      };
    };
    "typescript-3.9.7" = {
      name = "typescript";
