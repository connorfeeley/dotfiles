...
{ fetchgit, fetchurl, fetchFromGitHub }: {
  ...
  hlissner-hey = {
    ...
    "bin/hey" = builtins.readFile
      ./hlissner-hey-089f1a9da9018df9e5fc200c2d7bef70f4546026/bin/hey;
    "config/zsh/completions/_hey" = builtins.readFile
      ./hlissner-hey-089f1a9da9018df9e5fc200c2d7bef70f4546026/config/zsh/completions/_hey;
    date = "2022-09-19";
  };
  hug = {
    pname = "hug";
  ...
  ssh-cmc = {
    ...
    cmc =
      builtins.readFile ./ssh-cmc-d5085c30d41ea1db96b1c119338fc6501fd09900/cmc;
    date = "2022-09-30";
  };
}
