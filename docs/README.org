...
mount -t zfs -o zfsutil npool/nixos/root /mnt
mount -t zfs -o zfsutil npool/nixos/home /mnt/home/cfeeley
mount -t zfs -o zfsutil bpool/nixos/root /mnt/boot

nixos-enter --root /mnt/zfs/

nixos-rebuild --install-bootloader --flake .#workstation switch
