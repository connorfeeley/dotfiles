...
in {
  nix = {
    ...
    settings.builders = [
      ...
      "cfeeley@proxmox-builder x86_64-linux,i686-linux /etc/nix/proxmox_builder_ed25519 8 8 nixos-test,benchmark,big-parallel,kvm - c3NoLWVkMjU1MTkgQUFBQUMzTnphQzFsWkRJMU5URTVBQUFBSUd1dDhFM1hLVzNZcVpHMm5VVGxXU3FzdWNJQ2NNYzFBeml1Ky9ocWQ0M0Mgcm9vdEBwcm94bW94LWJ1aWxkZXIK"
    ];
